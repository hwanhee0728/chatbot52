...
st.markdown('<a href="https://kmlasurvey.streamlit.app/" target="_blank">챗봇 사용후 Feedback주실 분 여기 클릭!</a>', unsafe_allow_html=True)
...
if password:
    if password == password_key:
        ...
        if user_input:
            ...
            llm = ChatOpenAI(model_name="gpt-4o", temperature=0.1, streaming=True, callbacks=[stream_handler], max_tokens=2000)
